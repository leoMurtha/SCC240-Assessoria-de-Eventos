...
CREATE TABLE PESSOA (
    ...
    CONSTRAINT CK_PESSOA_TIPO CHECK(TIPO IN ('NOIVO', 'FORMANDO', 'FUNCIONARIO'))
);
...
CREATE TABLE SERVICO(
	...
	CONSTRAINT CK_TIPO_SERVICO CHECK(TIPO IN ('ESTILIZACAO', 'FLORISTA', 'SEGURANCA', 'DECORACAO', 'BUFFET'))
);
------------------------------------------------------------------------------------
